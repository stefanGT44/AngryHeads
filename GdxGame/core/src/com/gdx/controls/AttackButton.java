...
public class AttackButton {
	 ...
	 */
	public AttackButton(float x, float y, Stage stage, Player player) {
		this.player = player;
		image = new Image(GdxGame.get().assets.get("Buttons/attackIcon.png", Texture.class));
		image.setX(x);
		image.setY(y);
		image.setScale(0.9f);
